...
$_['text_meta_section'] = 'Meta Conversions API';
...
$_['entry_meta_capi_status'] = 'Enable Meta CAPI Purchase';
$_['entry_meta_pixel_id'] = 'Meta Pixel / Dataset ID';
$_['entry_meta_access_token'] = 'Conversions API access token';
$_['entry_meta_test_event_code'] = 'Test event code (optional)';
...
$_['help_meta_capi'] = 'Server-side Purchase on checkout/success with the same event_id as the browser pixel (ecommerce.transaction_id). Token stays in OpenCart settings only — never commit it to git.';
$_['help_meta_pixel_id'] = 'Meta Pixel / Dataset ID from Events Manager.';
$_['help_meta_access_token'] = 'Paste the Conversions API token from Events Manager. Visible only in this admin screen.';
$_['help_meta_test_event_code'] = 'Optional Events Manager test code (Test events). Leave empty in production.';
$_['help_consent'] = 'Shows a cookie banner and sets Google Consent Mode v2 defaults before GTM. Requires GTM to be enabled. Matomo is not controlled by this banner. Meta CAPI also requires grant (ad_storage cookie).';
$_['error_meta_pixel_id'] = 'Meta Pixel / Dataset ID is required when Meta CAPI is enabled.';
$_['error_meta_access_token'] = 'Conversions API access token is required when Meta CAPI is enabled (or keep an existing stored token).';
