...
$_['text_confirm_blacklist'] = 'Blacklist the emails of the selected requests and move them to Spam?';
$_['text_confirm_blacklist_stopwords'] = 'Blacklist emails, move tickets to Spam, and add all customer message phrases to stop words (trailing dots removed)?';
...
$_['text_success_blacklist'] = 'Blacklist updated. Added: %d, already listed or invalid: %d. Moved to Spam: %d.';
$_['text_success_blacklist_stopwords'] = 'Blacklist updated. Added: %d, already listed or invalid: %d. Moved to Spam: %d. Stop words added: %d.';
...
$_['text_status_spam'] = 'Spam';
$_['tab_tickets'] = 'Tickets';
$_['tab_spam'] = 'Spam';
...
$_['entry_antispam_stopwords'] = 'Stop words';
...
$_['text_recaptcha_heading'] = 'Google reCAPTCHA (invisible)';
...
$_['entry_msg_recaptcha'] = 'reCAPTCHA failed';
...
$_['help_antispam_stopwords'] = 'One phrase per line (case-insensitive substring). Matching messages are stored as Spam (Spam tab only) — no confirmation email and no admin notification. Lines starting with # are ignored.';
$_['help_recaptcha'] = 'Google reCAPTCHA v2 Invisible. Fill both keys to enable. Create keys at https://www.google.com/recaptcha/admin (type: reCAPTCHA v2 → Invisible). Leave empty to disable.';
...
$_['button_blacklist'] = 'Blacklist selected → Spam';
$_['button_blacklist_stopwords'] = 'Blacklist + stop words → Spam';
