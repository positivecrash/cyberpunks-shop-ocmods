...
class ModelExtensionPaymentRevolut extends Model
{
    ...
    public function registerApplePayDomain($domain)
    {
        ...
        // Return full result (http_code + response). Stock plugin returned only
        // response body, so admin domain registration always looked like a failure.
        return $api_client->post('apple-pay/domains/register', ['domain' => $domain]);
    }
