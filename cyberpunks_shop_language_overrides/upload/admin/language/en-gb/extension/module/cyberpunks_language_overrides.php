...
$_['text_success_import'] = 'Import finished: %d created, %d updated, %d skipped.';
$_['text_import_export_help'] = 'Export downloads a CSV (Original EN, comment, one column per language). Import merges by Original EN: non-empty cells update translations; empty cells leave existing values.';
...
$_['error_import_file'] = 'Warning: Please choose a CSV file to import.';
$_['error_import_type'] = 'Warning: Only CSV files are supported.';
